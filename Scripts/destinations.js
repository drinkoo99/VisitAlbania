...
const beaches = [
  { 
    ...
    description: "Ksamil Beach offers crystal-clear turquoise waters, soft white sand, and an unforgettable Mediterranean vibe. Perfect for sunbathing, swimming, and exploring small nearby islands by boat. Ideal for families and couples looking for a relaxing holiday. Local cafes and restaurants provide fresh seafood and traditional Albanian dishes, making your visit even more enjoyable.",
  ...
  { 
    ...
    description: "Gjipe Beach is a hidden gem at the end of Gjipe canyon, surrounded by cliffs and pristine nature. Ideal for those seeking tranquility, nature walks, or kayaking through crystal-clear waters. A perfect escape from crowded tourist areas. Enjoy cliff diving or simply relax under the shade of pine trees while listening to the waves.",
  ...
  { 
    ...
    description: "Jale Beach is vibrant and lively, with turquoise waters perfect for swimming and snorkeling. Cafes and beach bars make it ideal for socializing and enjoying local cuisine. Popular among young travelers and backpackers. At sunset, the beach turns into a lively atmosphere with music and beach parties.",
  ...
  { 
    ...
    description: "Mirror Beach is small, secluded, and serene, ideal for visitors seeking peace. Calm waters, natural beauty, and surrounding cliffs make it perfect for photography and intimate escapes. Ideal for couples or solo travelers. The mirrored reflections in the water create a magical scene at dawn and dusk.",
    link: "https://www.booking.com/hotel/al/vila-zevro.html"
  },
  { 
    title: "Borsh Beach", 
    image: "Images/Beaches/borsh.webp", 
    description: "Borsh Beach stretches along the Ionian coast with golden sand and scenic olive groves. Perfect for long walks, swimming, and exploring traditional villages nearby. Great for travelers looking for nature and quiet surroundings. Local taverns offer authentic Albanian cuisine and fresh seafood right by the sea.",
  ...
  { 
    ...
    description: "Dhermi Beach is famous for its turquoise waters, pebble shoreline, and lively summer atmosphere. Ideal for sunbathing, water sports, and vibrant beachside cafes. Offers both relaxation and entertainment in one destination. Hike to nearby viewpoints for panoramic views of the Ionian coast and surrounding mountains.",
...
const mountains = [
  {
    title: "Korab Mountains",
    image: "Images/Mountains/korabi.webp",
    description: "Korab Mountains are the highest in Albania, offering breathtaking views and adventurous hiking trails. Perfect for trekking, nature photography, and enjoying alpine flora. Trails vary from moderate to challenging, suitable for both beginners and experienced hikers.",
    link: "https://www.booking.com/searchresults.html?ss=Korab+Mountains"
  },
  {
    title: "Bjeshkt e Nemuna",
    image: "Images/Mountains/bjeshket-nemuna.webp",
    description: "Bjeshkt e Nemuna, also known as Accursed Mountains, are famous for their dramatic cliffs, deep valleys, and pristine nature. Ideal for hiking, climbing, and exploring traditional mountain villages. Rich in flora and fauna, this region is a paradise for nature lovers.",
    link: "https://www.booking.com/searchresults.html?ss=Bjeshkt+e+Nemuna"
  },
  {
    title: "Tomorr Mountains",
    image: "Images/Mountains/tomorri.webp",
    description: "Tomorr Mountains are known for their cultural and spiritual significance, surrounded by lush landscapes. Great for trekking, spiritual retreats, and panoramic photography. The area offers a unique combination of nature and history.",
...
const rivers = [
  {
    ...
    description: "The Drini River, the longest river in Albania, flows through breathtaking mountainous landscapes, offering crystal-clear waters and untouched nature. Ideal for kayaking, fishing, and riverside hikes, the Drini provides an immersive experience in Albania's pristine wilderness. Travelers can explore traditional villages along its banks and enjoy local cuisine while taking in panoramic views of the surrounding Alps."
  },
  {
    title: "Buna River",
    image: "Images/Rivers/buna.webp",
    description: "The Buna River originates from Lake Shkodra and winds its way through lush forests and diverse ecosystems. Perfect for nature enthusiasts and bird watchers, it offers calm boating experiences and scenic riverbanks. Along its course, visitors can discover historical landmarks and traditional settlements, combining adventure with culture and relaxation."
  },
  {
    title: "Shala River",
    image: "Images/Rivers/shala.webp",
    description: "The Shala River is renowned for its turquoise-blue waters and dramatic canyons, often referred to as the 'Albanian Thailand'. Surrounded by steep cliffs and verdant hills, it offers opportunities for rafting, swimming, and photography. Its serene environment and unspoiled nature make it a favorite destination for adventurers and travelers seeking tranquility."
  },
  {
    title: "Vjosa River",
    image: "Images/Rivers/vjosa.webp",
    description: "The Vjosa River is one of Europe’s last wild rivers, flowing freely through deep canyons and valleys. Ideal for rafting, kayaking, and eco-tourism, the river is home to diverse flora and fauna. Visitors can enjoy its untouched landscapes, scenic viewpoints, and charming riverside villages, experiencing the raw beauty of Albania’s natural heritage."
  }
];
...
const countryside = [
  {
    ...
    description: "Located deep in the Albanian Alps, Theth is a peaceful village known for its dramatic mountain scenery, crystal-clear rivers, and iconic landmarks like the Blue Eye of Theth and the centuries-old stone tower of blood feuds. It is a top destination for hikers, nature lovers, and anyone seeking authentic Albanian rural culture in one of the most untouched places in Europe."
  },
  {
    title: "Valbona",
...
// ====================================
// NATIONAL PARKS ARRAY
// ====================================
const nationalParks = [
  {
    title: "Theth National Park",
    image: "Images/National-Parks/theth-national.webp",
    description: "Theth National Park is a spectacular alpine paradise located in the heart of the Albanian Alps. Known for its dramatic peaks, crystal-clear rivers, and untouched forests, it offers some of the best hiking trails in the Balkans. Visitors are drawn to landmarks such as the Church of Theth, the Grunas Waterfall, and the iconic Blue Eye of Theth, a stunning natural spring with turquoise waters. The traditional stone houses and warm hospitality of the locals create an authentic cultural experience. This national park is perfect for adventurers, nature lovers, and anyone seeking peace in breathtaking high-mountain landscapes."
  },
  {
    title: "Butrint National Park",
    image: "Images/National-Parks/butrint.webp",
    description: "Butrint National Park is a unique blend of archaeology and nature, protecting one of the most important ancient cities in the Mediterranean region. Surrounded by lakes, forests, and wetlands, the park features well-preserved monuments from Greek, Roman, Byzantine, and Venetian periods. Visitors can explore a majestic amphitheater, ancient temples, city gates, and a scenic acropolis overlooking the Vivari Channel. Its rich biodiversity makes it a haven for wildlife lovers, while history enthusiasts can enjoy a journey through thousands of years of culture. Butrint is a magical place where history and nature coexist in harmony."
  },
  {
    title: "Korab-Koritnik National Park",
  ...
  },
  {
    ...
    description: "Valbona Valley National Park is a breathtaking alpine destination often described as ‘The Miracle of the Alps’. Surrounded by towering peaks, crystal-clear rivers, and colorful meadows, the valley offers unforgettable hiking and outdoor experiences. Travelers can explore traditional villages, enjoy delicious local cuisine, and stay in cozy guesthouses run by welcoming locals. Whether hiking to the Valbona Pass, capturing stunning photography, or simply relaxing in nature’s silence, visitors will find this national park one of the most beautiful and inspiring places in all of Albania."
  },
]

// ========================================================
// DATABASE OF DESTINATIONS (ADD MORE CATEGORIES ANYTIME)
// ========================================================
const destinations = {
  beaches: beaches,         // from beaches.js or inside this file
...
// ========================================================
// SAFE NAVIGATION HANDLERS (WORKS DESKTOP + MOBILE)
// ========================================================
function setupRedirect(className, destinationType) {
...
// Dropdown Navbar
setupRedirect(".destinations-beaches", "beaches");
setupRedirect(".destinations-mountains", "mountains");
setupRedirect(".destinations-rivers", "rivers");
setupRedirect(".destinations-lakes", "lakes");
setupRedirect(".destinations-countryside", "countryside");
setupRedirect(".destinations-historicCities", "historicCities");
setupRedirect(".destinations-nationalParks", "nationalParks");
...
document.addEventListener("DOMContentLoaded", () => {
  const root = document.getElementById("destinations-root");
  if (!root) return; // Stop if not on destinations.html
